...
if sentiment >= 0: 
    print('ah, ', Find_Subject.find_Subject(search), 'I like how ' ,nsubj[random.randint(0,len(nsubj)-1)],dobj[random.randint(0,len(dobj)-1)],aux[random.randint(0,len(aux)-1)],root[random.randint(0,len(root)-1)],nsubj[random.randint(0,len(nsubj)-1)])

if sentiment <= 0:
    print('ah, ', Find_Subject.find_Subject(search), 'I dislike how ' ,nsubj[random.randint(0,len(nsubj)-1)],dobj[random.randint(0,len(dobj)-1)],aux[random.randint(0,len(aux)-1)],root[random.randint(0,len(root)-1)],nsubj[random.randint(0,len(nsubj)-1)])